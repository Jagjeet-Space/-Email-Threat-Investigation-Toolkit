...
Down below, we will analyze [analyze_headers.py](../../phishscan/utils/analyze_headers.py) key secripts modules and function that will tell us, what each of them do.
